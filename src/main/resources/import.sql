...
CREATE TABLE TB_BOARD (IDX BIGINT GENERATED BY DEFAULT AS IDENTITY, CONTENTS VARCHAR(255), CREATED_BY VARCHAR(255), TITLE VARCHAR(255), CITY VARCHAR(255) , LIKES INT , IMAGE VARCHAR(255), PRIMARY KEY (IDX));
